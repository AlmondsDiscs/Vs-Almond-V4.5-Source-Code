	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['Vs Almond by'], 15);
					#else
				...
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('AlmondsDemo', 15);
					addMoreText('Xyriax', 15);
					addMoreText('Yin', 15);
					#else
					addMoreText('present');
					#end
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['was never associated', 'with'], -40);
					#else
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Almond'); // credTextShit.text += '\nFunkin';

				case 16:
					addMoreText('Thats right');
