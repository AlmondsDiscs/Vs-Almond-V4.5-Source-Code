...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Are you kidding me', 0.2], //From 0% to 19%
		['how the', 0.4], //From 20% to 39%
		['You\'re bad', 0.5], //From 40% to 49%
		['yea ok', 0.6], //From 50% to 59%
		['Fine', 0.69], //From 60% to 68%
		['Trolled', 0.7], //69%
		['Cool', 0.8], //From 70% to 79%
		['Yeaaa', 0.9], //From 80% to 89%
	...
	var dialogue:Array<String> = ['my name is almond', 'and i am very cool'];
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['week1_nomiss', 'week2_nomiss', 'week3_nomiss', 'week4_nomiss',
				...
				'ur_good', 'hype', 'two_keys', 'toastie', 'debugger', 'birthday']);
