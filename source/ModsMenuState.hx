...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("i put back the mods menu in the MainMenuState.hx hehehehehehhe", null);
		#end

		bg = new FlxSprite().loadGraphic(Paths.image('menuBG3'));
		bg.antialiasing = ClientPrefs.globalAntialiasing;
		add(bg);
		bg.screenCenter();

		noModsTxt = new FlxText(0, 0, FlxG.width, "why did you put this back\ntake this thing out now", 48);
